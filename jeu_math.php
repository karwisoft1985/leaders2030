...
<object width="500" height="350" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0">
 <param name="movie" value="games/RESAD01.swf" />
    <param name="quality" value="high" />
    <embed src="games/RESAD01.swf" width="500" height="350"quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" ></embed>
  </object>
            </div>
			        	<div class="cell-sm-6 cell-md-6">             
<object width="500" height="350" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" >
 <param name="movie" value="games/COMPTSN5.swf" />
    <param name="quality" value="high" />
    <embed  width="500" height="350" src="games/COMPTSN5.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" ></embed>
  </object>
            </div>
       
				<div class="cell-sm-6 cell-md-6">             
<object width="500" height="350"  codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0">
 <param name="movie" value="games/MULTIPL01.swf" />
    <param name="quality" value="high" />
    <embed width="500" height="350" src="games/MULTIPL01.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" ></embed>
  </object>
            </div>
	
		 	<div class="cell-sm-6 cell-md-6">             
<object width="480" height="350" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0">
 <param name="movie" value="games/OBTDIV01.swf" />
    <param name="quality" value="high" />
    <embed width="480" height="350" src="games/OBTDIV01.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" ></embed>
  </object>
            </div>
					</div>       
